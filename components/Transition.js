...
const Transition = () => {
  return (
    <>
      ...
      bg-[#233dff] ' variants={transitionVariants} initial='initial' animate="animate" 
      ...
      bg-[#ffffff] ' variants={transitionVariants} initial='initial' animate="animate" 
      ...
      bg-[#050a30] ' variants={transitionVariants} initial='initial' animate="animate" 
